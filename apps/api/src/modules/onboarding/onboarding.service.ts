...
export class OnboardingService {
  ...
  async getStatus(therapistId: string): Promise<OnboardingStatus> {
    const state = await this.repo.findByTherapistId(therapistId);
  ...
  async savePracticeInfo(therapistId: string, data: { practiceName: string; city: string; state: string }): Promise<OnboardingStatus> {
